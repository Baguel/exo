...
<body>
    <div class="mx:auto p-10 bg-slate-100">
        <div class=" flex flex-row min-h-screen justify-center items-center">
            <div class="bg-white w-[500px] h-[750px] p-5 border-2 rounded-lg">
                <p class="text-2xl font-bold">Create a free account</p>
                <p class="mt-2 font-thin">Your free assistant for everyday task</p>
                <div>
                    <div class="space-y-5">
                ...
                <form action="">
                    ...
                    <button class="w-full bg-green-500 rounded-full h-10 mt-7">Sign up</button>
                </form>    
